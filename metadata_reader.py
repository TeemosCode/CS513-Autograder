...
class JSONMetadataReader(MetadataReader):
    ...
    __query_file_suffix = ".sql"  ### Student SQL solution files ...
    ...
    def __init__(self, json_file_path, solutions_dir):
        ...
        self.solutions_dir = solutions_dir   ### The solutions directory
    ...
    def query_file_path(self, problem_name):
        ...
        query_file_path = os.path.join(self.solutions_dir, query_file)  # solutions/problem.sql ....
    ...
    @staticmethod
    def __resolve_path(path):  # File Path  ...solutions/problem.sql ....
